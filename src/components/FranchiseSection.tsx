...
export const FranchiseSection: React.FC<FranchiseSectionProps> = ({ currentLang, onOpenFranchiseModal }) => {
  ...
  return (
    <section id="franchise" className="py-24 bg-[#0d0b0d] relative overflow-hidden border-t border-[#d4af37]/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="glass-card p-6 rounded-3xl text-center space-y-1 border border-[#d4af37]/20">
            ...
            <div className="text-xs text-[#b0a5b5]">{t('franchise.stat_roi_label')}</div>
          </div>
          ...
          <div className="glass-card p-6 rounded-3xl text-center space-y-1 border border-[#d4af37]/20">
            ...
            <div className="text-xs text-[#b0a5b5]">{t('franchise.stat_margin_label')}</div>
          </div>
          ...
          <div className="glass-card p-6 rounded-3xl text-center space-y-1 border border-[#d4af37]/20">
            ...
            <div className="text-xs text-[#b0a5b5]">Salon Bookings + Academy Fees</div>
          </div>
        </div>
        ...
        <div className="mt-14 max-w-4xl mx-auto glass-card p-8 sm:p-10 rounded-3xl border border-[#d4af37]/30 relative">
          ...
          <div className="space-y-6">
            {/* Range Slider */}
            <div>
              <div className="flex justify-between items-center mb-2 text-xs font-bold text-[#e0d8ce]">
              ...
              />
              <div className="flex justify-between text-[10px] text-[#a095a5] mt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-5 rounded-2xl bg-[#161217] border border-[#d4af37]/20">
                <div className="text-xs text-[#a095a5] mb-1">{t('franchise.calc_est_monthly')}</div>
                <div className="text-2xl sm:text-3xl font-bold text-white">
                  ₹{monthlyRevenue.toLocaleString('en-IN')}
                </div>
              </div>

              <div className="p-5 rounded-2xl bg-[#161217] border border-[#d4af37]/30">
            ...
            {/* Franchise Key Perks */}
            <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-[#c0b5a8]">
