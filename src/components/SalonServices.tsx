...
export const SalonServices: React.FC<SalonServicesProps> = ({ currentLang, onSelectServiceToBook }) => {
  ...
  return (
    <section id="services" className="py-24 bg-[#0d0b0d] relative overflow-hidden border-t border-[#d4af37]/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {(selectedCategory === 'all' || selectedCategory === 'bridal') && (
          <div className="mt-10 rounded-3xl p-6 sm:p-8 bg-gradient-to-r from-[#1c141d] via-[#2a1d2e] to-[#1c141d] border border-[#d4af37]/40 shadow-2xl relative overflow-hidden">
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="text-2xl font-serif-luxury font-bold text-gold-gradient">
                    ₹4,999 <span className="text-xs font-sans text-[#a095a5]">Onwards</span>
                  </div>
                </div>
                <p className="text-xs sm:text-sm text-[#d0c5b8] leading-relaxed">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-2 text-xs text-[#e0d8ce]">
                  <div className="flex items-center gap-2 bg-[#0d0b0d]/60 px-3 py-2 rounded-xl border border-[#d4af37]/20">
                  ...
                  <div className="flex items-center gap-2 bg-[#0d0b0d]/60 px-3 py-2 rounded-xl border border-[#d4af37]/20 col-span-2 sm:col-span-1">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#d4af37]" />
                ...
                <div className="pt-2 flex items-center gap-4">
                  ...
                  <span className="text-xs text-[#a095a5]">Duration: 120 Mins</span>
                </div>
              </div>
            </div>
          </div>
            ...
            >
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="text-right shrink-0">
                      ...
                      <div className="text-[10px] text-[#a095a5]">Onwards</div>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 space-y-1.5 border-t border-[#d4af37]/15">
                    {service.featuresKeys.map((feat, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-xs text-[#d0c5b8]">
              ...
              <div className="p-6 pt-0">
                <button
                  ...
                  className="w-full py-3 rounded-full bg-gradient-to-r from-[#161217] via-[#241d26] to-[#161217] hover:from-[#d4af37] hover:to-[#aa7c11] text-xs font-bold text-[#f7e7ce] hover:text-[#0d0b0d] border border-[#d4af37]/40 hover:border-transparent transition-all flex items-center justify-center gap-2 shadow-md"
                >
                  <Calendar className="w-4 h-4" />
