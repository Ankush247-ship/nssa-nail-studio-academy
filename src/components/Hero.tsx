    ...
    <section className="relative min-h-screen pt-28 pb-16 lg:pt-36 lg:pb-24 flex items-center justify-center overflow-hidden bg-[#0d0b0d]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="mb-6 flex justify-center lg:justify-start">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#d4af37]/40 bg-[#1c141d] backdrop-blur-md text-xs font-semibold text-[#f7e7ce] shadow-lg shadow-[#d4af37]/10 animate-pulse">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2 text-xs text-[#e0d8ce]">
              ...
              <div className="flex items-center gap-2 bg-[#161217]/90 border border-[#d4af37]/25 px-3 py-2 rounded-xl">
                <Star className="w-4 h-4 text-[#d4af37] fill-current shrink-0" />
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-[#d4af37] via-[#f3e5ab] to-[#aa7c11] text-sm font-bold text-[#0d0b0d] hover:brightness-110 transition-all flex items-center justify-center gap-3 shadow-xl shadow-[#d4af37]/25 hover:scale-[1.02] active:scale-95 group"
              >
                <Calendar className="w-5 h-5 text-[#0d0b0d]" />
                <span>Book Appointment</span>
                <ArrowRight className="w-4 h-4 text-[#0d0b0d] group-hover:translate-x-1 transition-transform" />
              </button>

              <button
                onClick={onOpenAdmission}
                className="w-full sm:w-auto px-8 py-4 rounded-full border border-[#d4af37]/60 bg-[#161217] text-sm font-semibold text-[#f7e7ce] hover:bg-[#d4af37]/20 transition-all flex items-center justify-center gap-3 shadow-lg hover:border-[#d4af37]"
              >
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4">
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2 overflow-hidden">
                  <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#d4af37]" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=100" alt="Client" />
                  <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#d4af37]" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=100" alt="Client" />
                  <img className="inline-block h-7 w-7 rounded-full ring-2 ring-[#d4af37]" src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&q=80&w=100" alt="Client" />
                </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Outer Golden Glow */}
              <div className="absolute -inset-2 bg-gradient-to-tr from-[#d4af37] via-[#e8a7a1] to-[#aa7c11] rounded-3xl blur-xl opacity-30 animate-pulse" />
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <div className="text-[10px] text-[#d4af37] font-extrabold uppercase tracking-wider flex items-center gap-1">
                        <Sparkles className="w-3 h-3" /> Guaranteed Academy Perk
                      </div>
        ...
        {/* Bottom Metrics Bar */}
        <div className="mt-16 sm:mt-20 grid grid-cols-2 md:grid-cols-6 gap-4 p-6 rounded-3xl glass-card border border-[#d4af37]/20 divide-y md:divide-y-0 md:divide-x divide-[#d4af37]/15">
