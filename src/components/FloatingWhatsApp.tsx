...
export const FloatingWhatsApp: React.FC = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="hidden md:flex fixed bottom-6 right-6 z-40 items-center gap-3 bg-[#161217] border border-[#d4af37]/40 p-2.5 pr-5 rounded-full shadow-2xl hover:scale-105 transition-transform group"
